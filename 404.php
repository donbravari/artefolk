...
<!-- Contenido de página de inicio -->
  ...
  <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        ...
        <h2>Oh oh! no hemos encontrado lo que buscabas</h2>
        <p>Al parecer el contenido que estas buscando ha sido movido o no se encuentra disponible
        </p>
        <a class="btn btn-primary"  href="<?php echo get_home_url(); ?>">Ir al inicio</a>
      </div>
    </div>
  </section>
